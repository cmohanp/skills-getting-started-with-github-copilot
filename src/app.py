...
activities = {
    ...
    "Soccer Team": {
        "description": "Team sports training and competitive matches",
        "schedule": "Tuesdays and Thursdays, 4:00 PM - 5:30 PM",
        "max_participants": 22,
        "participants": ["sara@mergington.edu", "noah@mergington.edu"]
    },
    "Swimming Club": {
        "description": "Lap swimming, water safety, and drills",
    ...
    "Debate Team": {
        "description": "Research, public speaking, and competitive debate",
        "schedule": "Tuesdays, 4:00 PM - 5:30 PM",
        "max_participants": 16,
        "participants": ["natalie@mergington.edu", "oliver@mergington.edu"]
    },
    "Science Club": {
